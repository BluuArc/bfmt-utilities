[@bluuarc/bfmt-utilities](../README.md) › [Globals](../globals.md) › ["leader-skills"](_leader_skills_.md)
...
*Defined in [leader-skills.ts:7](https://github.com/BluuArc/bfmt-utilities/blob/8f0140f/src/leader-skills.ts#L7)*
