[@bluuarc/bfmt-utilities - v0.6.0](../README.md) › [Globals](../globals.md) › ["buff-metadata"](_buff_metadata_.md)
...
* [PASSIVE_METADATA](_buff_metadata_.md#const-passive_metadata)
* [PROC_METADATA](_buff_metadata_.md#const-proc_metadata)
...
*Defined in [buff-metadata.ts:18](https://github.com/BluuArc/bfmt-utilities/blob/master/src/buff-metadata.ts#L18)*
...
*Defined in [buff-metadata.ts:449](https://github.com/BluuArc/bfmt-utilities/blob/master/src/buff-metadata.ts#L449)*
