[@bluuarc/bfmt-utilities - v0.8.0](../README.md) › [Globals](../globals.md) › ["buffs/parsers/buff-types"](../modules/_buffs_parsers_buff_types_.md) › [IGenericBuffValue](_buffs_parsers_buff_types_.igenericbuffvalue.md)
