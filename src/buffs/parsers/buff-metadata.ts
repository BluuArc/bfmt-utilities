...
export const BUFF_METADATA: Readonly<{ [id: string]: IBuffMetadata }> = Object.freeze({
	...
	'passive:10008:mitigation-bb': {
		id: BuffId['passive:10008:mitigation-bb'],
		name: 'Passive Damage Reduction (Brave Bursts only)',
		stat: UnitStat.skillMitigation,
		stackType: BuffStackType.Passive,
		icons: () => [IconId.BUFF_BBDMGDOWN],
	},
	'passive:10008:mitigation-sbb': {
		id: BuffId['passive:10008:mitigation-sbb'],
		name: 'Passive Damage Reduction (Suer Brave Bursts only)',
		stat: UnitStat.skillMitigation,
		stackType: BuffStackType.Passive,
		icons: () => [IconId.BUFF_SBBDMGDOWN],
	},
	'passive:10008:mitigation-ubb': {
		id: BuffId['passive:10008:mitigation-ubb'],
		name: 'Passive Damage Reduction (Ultimate Brave Bursts only)',
		stat: UnitStat.skillMitigation,
		stackType: BuffStackType.Passive,
		icons: () => [IconId.BUFF_UBBDMGDOWN],
	},
	'passive:10008:mitigation-normals': {
		id: BuffId['passive:10008:mitigation-normals'],
		name: 'Passive Damage Reduction (Normal Attacks only)',
		stat: UnitStat.normalAttackMitigation,
		stackType: BuffStackType.Passive,
		icons: () => [IconId.BUFF_NORMALATTACKREDUCTION],
	},
	'passive:10008:mitigation-dot': {
		id: BuffId['passive:10008:mitigation-dot'],
		name: 'Passive Damage Reduction (Damage over Time only)',
		stat: UnitStat.damageOverTimeMitigation,
		stackType: BuffStackType.Passive,
		icons: () => [IconId.BUFF_ATKREDUC],
	},
	...
	'proc:10000:taunt': {
		id: BuffId['proc:10000:taunt'],
		name: 'Active Taunt',
		stat: UnitStat.targetingModification,
		stackType: BuffStackType.Active,
		icons: () => [IconId.SG_BUFF_TAUNT],
	},
	'proc:10000:taunt-atk': {
		id: BuffId['proc:10000:taunt-atk'],
		name: 'Active Attack Boost (from Taunt)',
		stat: UnitStat.atk,
		stackType: BuffStackType.Active,
		icons: () => [IconId.SG_BUFF_TAUNT, IconId.BUFF_ATKUP],
	},
	'proc:10000:taunt-def': {
		id: BuffId['proc:10000:taunt-def'],
		name: 'Active Defense Boost (from Taunt)',
		stat: UnitStat.def,
		stackType: BuffStackType.Active,
		icons: () => [IconId.SG_BUFF_TAUNT, IconId.BUFF_DEFUP],
	},
	'proc:10000:taunt-crit': {
		id: BuffId['proc:10000:taunt-crit'],
		name: 'Active Critical Hit Rate Boost (from Taunt)',
		stat: UnitStat.crit,
		stackType: BuffStackType.Active,
		icons: () => [IconId.SG_BUFF_TAUNT, IconId.BUFF_CRTRATEUP],
	},
